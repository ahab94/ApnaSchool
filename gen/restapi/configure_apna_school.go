...
func configureAPI(api *operations.ApnaSchoolAPI) http.Handler {
	...
	if api.GetTeacherHandler == nil {
		api.GetTeacherHandler = operations.GetTeacherHandlerFunc(func(params operations.GetTeacherParams) middleware.Responder {
