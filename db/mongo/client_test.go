...
func Test_client_AddStudent(t *testing.T) {
	...
	os.Setenv("DB_HOST", "apna-school-mongo-db")
	...
	tests := []struct {
	...
	}{
		{
			...
			args:    args{student: &models.Student{Name: "Ahmed", Age: "12", Department: "Army", Grade: 430}},
			wantErr: false,
		},
		{
			name:    "fail - add invalid student in db",
			args:    args{student: &models.Student{ID: "4", Name: "Talha", Age: "23", Department: "SE", Grade: 85}},
			wantErr: true,
		},
	}
...
func Test_client_AddTeacher(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:    args{teacher: &models.Teacher{Name: "Ahmed", Age: "12", Department: "Army", Salary: 430}},
			wantErr: false,
		},
		{
			name:    "fail - add invalid teacher in db",
			args:    args{teacher: &models.Teacher{ID: "2", Name: "Talha", Age: "23", Department: "SE", Salary: 85}},
			wantErr: true,
		},
	}
...
func Test_client_DeleteStudent(t *testing.T) {
	...
	c, _ := NewClient(db.Option{})
	student := &models.Student{Name: "Qamar Zaman Bajwa", Age: "12", Department: "Army", Grade: 430}
...
func Test_client_DeleteTeacher(t *testing.T) {
	...
	c, _ := NewClient(db.Option{})
	teacher := &models.Teacher{Name: "Qamar Zaman Bajwa", Age: "12", Department: "Army", Salary: 430}
...
func Test_client_UpdateStudent(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:    args{student: &models.Student{Name: "Talha", Age: "22", Department: "Wanclouds", Grade: 30}},
			wantErr: false,
		},
	}
...
func Test_client_UpdateTeacher(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args:    args{teacher: &models.Teacher{Name: "Talha", Age: "22", Department: "Wanclouds", Salary: 30}},
			wantErr: false,
		},
	}
